...
SECRET_KEY = 'django-insecure-xv$7o1)gj!=5zj6&r3=1hbhj+(24y)o#gcnnmmztjno3w-=^an'
...
# Use MySQL for local development or production outside of Vercel
else:
    DATABASES = {
        'default': {
